"""Evaluate a current instruction-specialized 4B base under the agent policy."""
...
baseline.RUN_DIR = baseline.ROOT / "training/runs/qwen3-4b-policy-baseline-v1"
baseline.RESULT = Path("/content/qwen3-4b-policy-baseline-v1-results.zip")
