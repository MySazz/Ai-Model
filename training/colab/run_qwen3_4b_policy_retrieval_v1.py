"""Evaluate the safe 4B base with local curriculum retrieval, without tuning."""
...
baseline.RUN_DIR = baseline.ROOT / "training/runs/qwen3-4b-policy-retrieval-v1"
baseline.RESULT = Path("/content/qwen3-4b-policy-retrieval-v1-results.zip")
