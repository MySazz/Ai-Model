"""Eight-family transfer diagnostic trained to the observed 15-epoch optimum."""
...
runner.RUN_DIR = runner.ROOT / "training/runs/transfer-diagnostic-v5"
runner.RESULT = Path("/content/transfer-diagnostic-v5-results.zip")
runner.EPOCHS = 15
